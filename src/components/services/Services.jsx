...
export default function Services() {
    return (
        <section className='my-[4em] min-h-[80vh]'>
            <motion.span id='services' className='text-slate-600 dark:text-white mb-[3em] flex justify-center font-bold text-3xl p-2 w-[220px] m-auto shadow-md rounded-md shadow-gray-400 bg-gray-300 ' initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ type: "spring", damping: 10, duration: 2 }}> Services</motion.span>
            <div className='flex justify-around items-center flex-col md:flex-row gap-8'>

                <motion.a href="#" className="w-[280px]  md:w-[300px] h-[350px] md:h-[310px]  block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-zinc-800 dark:border-gray-700 dark:hover:bg-gray-700" initial={{ x: -100, scale: 0 }} whileInView={{ x: 0, scale: 1 }} transition={{ type: "spring", damping: 10, duration: 1 }}>
                ...
                <motion.a href="#" className=" w-[280px] md:w-[300px] h-[350px] md:h-[310px] block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-zinc-800 dark:border-gray-700 dark:hover:bg-gray-700" layout initial={{ x: 100, scale: 0 }} whileInView={{ x: 0, scale: 1 }} transition={{ type: "spring", damping: 10, duration: 1 }}>
